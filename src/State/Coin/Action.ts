import {
    ...
    FETCH_COIN_BY_ID_REQUEST, FETCH_COIN_BY_ID_SUCCESS,
    FETCH_COIN_LIST_FAILURE,
    FETCH_COIN_LIST_REQUEST,
    FETCH_COIN_LIST_SUCCESS, FETCH_MARKET_CHART_FAILURE, FETCH_MARKET_CHART_REQUEST, FETCH_MARKET_CHART_SUCCESS,
    ...
    FETCH_TRADING_COINS_SUCCESS, SEARCH_COIN_FAILURE, SEARCH_COIN_REQUEST, SEARCH_COIN_SUCCESS
} from "./ActionType.ts";
...
export const getCoinList=(page)=>async(dispatch)=>{
    ...
    try{
        const {data}=await api.get(`/coins/coinlist?page=${page}`)
...
//     try {
//         const response = await axios.get(`${coinId}`,{
//             headers:{
//                 Authorization: `Bearer ${jwt}`
//             }
//         });
